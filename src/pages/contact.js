...
const ContactPage = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <h2 style={{ marginBottom: rhythm(1) }}>Contact</h2>
      ...
      <p>
        You can also message me on <a href="https://www.linkedin.com/in/sean-goedecke-5495a7137/">LinkedIn</a>, though I tend to give quicker responses there.
      </p>
