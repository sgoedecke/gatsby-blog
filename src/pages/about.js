...
const AboutPage = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>Hi! I'm Sean Goedecke, an Australian software engineer. I write about software engineering, with a focus on AI and large-company dynamics. If you want to know more about my background, my resume is publicly available <a target="_blank" href="https://docs.google.com/document/d/17Ql6AydCJ7-XhjrwEqzmRAaAaooARTS5vjEhBZGfrbE/edit?tab=t.0">here</a></p>
