...
**Forced multitasking is the most stressful thing about working in tech.** No matter how hard you try to fill your downtime with low-priority tasks, sometimes you get it wrong or one of the tasks blows up, and you're in the position of having to juggle two or three important tasks at once. If I could somehow only ever work on one thing until it was done, then move onto the next thing, I don't think this would be a stressful job at all.

Managing concurrent tasks is thus one of the most important skills you can develop. I've written at length about it twice, in [_Why strong engineers are rarely blocked_](/becoming-unblockable/) and [_Becoming unblockable_](/unblockable/). There are lots of things you can do to make it easier: planning projects with concurrency in mind, sequencing blocking tasks as early as possible, proactively building relationships with teams you depend on, being willing to call in air support from senior management, and so on.

One of the tricky things about multitasking is that a task split that seems okay at first can blow up
