...
Let's amortize the cost of the GPUs, since that's going to be the main cost driver. An A100 costs about $20k. If each A100 lasts around five years[^3], you'll have to make 16k/yr in profit to recoup your capital investment (or $1.80 per hour). At lower utilization, it'll take longer to recoup, but your GPUs will also last longer. Either way, your overall inference costs are at about one dollar per million tokens.
