...
It's possible that you're paid to write software that an LLM could never write. There are some rare cases where people are still paid to drive steel by hand. Like most of my colleagues, I spend my time writing web apps and services: in Ruby, Golang, and React, mostly. With a bit of taste and guidance, I can pilot an LLM[^2] through about three-quarters of it (though in practice only about one-third of my code is first drafted by an LLM agent, since sometimes it's just quicker and easier to drive myself). A year ago, that figure was closer to one-tenth. The steam drill is coming for me, too.
