...
popularity:
  ...
  hackerNews:
    ...
    threads: 1
    urls:
      - 'https://news.ycombinator.com/item?id=45946498'
  lobsters:
    points: 0
    comments: 0
    threads: 0
...
The very first LLM-based product, ChatGPT, was just[^1] the ability to talk with the model itself: in other words, a pure chatbot. This is still the most popular LLM product by a large margin.
...
In other words, your users will just use ChatGPT[^2]. AI labs have two decisive advantages over you: first, they will always have access to the most cutting-edge models before you do; and second, they can develop their chatbot harness simultaneously with the model itself (like how Anthropic specifically trains their models to be used in Claude Code, or OpenAI trains their models to be used in Codex).
...
Why will your chatbot lose? Because **chat is not a good user interface**. Users simply do not want to type out "hey, can you increase the font size for me" when they could simply hit "ctrl-plus" or click a single button[^3].
